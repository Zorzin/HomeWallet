    ...
    $.fn.incrementalCounter = function(options){
        ...
        var defauts = {
            ...
            start = function(element){
                ...
                var current_value = parseFloat($(element).data('current_value')),
                    end_value = parseFloat($(element).data('end_value')),
                    current_speed = 20;
                if (end_value - current_value <= 1) {
                    current_speed = 2;
                    current_value += 0.01;
                    ...
                    current_speed = 25;
                    current_value += (end_value - current_value) / 24;
        ...
        this.each(function(index,element){
            ...
            var default_digits = options.digits ,
                ...
                end_value =  parseFloat(element.getAttribute('data-value'));
